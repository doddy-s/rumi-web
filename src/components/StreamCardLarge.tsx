  ...
  return (
    <>
      <div className="h-[16rem] w-[12rem] overflow-hidden rounded-sm">
        ...
        <Link to="/watch/$streamId" params={{ streamId: stream?.consumetId }} search={{ episodeId: null }} className="relative flex flex-col justify-between items-start h-full w-full p-2 
